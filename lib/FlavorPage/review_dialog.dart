        ...
        content: Form(
          ...
          actions: <Widget>[
            ...
            Visibility(
              ...
              onPressed: () { 
                  Navigator.pop(context, [widget.review, 2]); // 2 = delete review
                }
              )
            )
              ),
            MaterialButton(
              ...
              onPressed: (){ 
                if (_formKey.currentState.validate()) {
                  ...
                  widget.review == null ? Navigator.pop(context, [newReview, 0]) : Navigator.pop(context, [newReview, 1]); // 0 = new review, 1 = edit review
                }
              },
            ),
            ],
